...
class GalleryVideo(models.Model):
    ...
    # The slug is what we will use to find the video in our text
    slug = models.SlugField(unique=True, blank=True)
    # resource_type='video' is critical for Cloudinary to serve the correct URL
